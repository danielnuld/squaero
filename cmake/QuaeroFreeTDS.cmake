...
# system FreeTDS exists, notably the x86 Windows release (Informix forces the
# whole app to x86, and no 32-bit FreeTDS ships).
#
...
function(quaero_enable_freetds target)
  ...
  if(NOT TARGET quaero_freetds_build)
    ...
    ExternalProject_Add(quaero_freetds_build
      ...
      CMAKE_ARGS
        ...
        -DWITH_OPENSSL=ON
        -DOPENSSL_ROOT_DIR=${_ossl_prefix}
  ...
  # it carries its own system libraries after it. db-lib's Windows dependencies
  # (sockets, SSPI, the crypto API) follow.
  target_link_libraries(${target} PRIVATE ${_libs} ${_libs} quaero_openssl_ssl
    ws2_32 secur32 crypt32 advapi32 shell32)
endfunction()
