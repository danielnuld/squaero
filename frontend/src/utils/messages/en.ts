...
export const en: Record<string, string> = {
  ...
  "cform.ifxPortReview": "Squaero no longer uses IBM's Client SDK: it now connects to the server's DRDA listener (drsoctcp, usually {port}). This port comes from the old settings and may not be the DRDA one; check it before saving.",
  "field.tls": "TLS",
