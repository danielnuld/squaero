...
export const es: Record<string, string> = {
  ...
  "cform.ifxPortReview": "Squaero ya no usa el Client SDK de IBM: ahora se conecta al listener DRDA del servidor (drsoctcp, normalmente el {port}). Este puerto viene de la configuración anterior y no sabemos si es el DRDA; compruébalo antes de guardar.",
  "field.tls": "TLS",
