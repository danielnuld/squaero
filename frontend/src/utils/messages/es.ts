...
export const es: Record<string, string> = {
  ...
  "ios.edit.readOnlyEngine": "Solo lectura: este motor no permite editar filas desde Squaero.",
  "ios.edit.noPk": "Solo lectura: la tabla no tiene clave primaria que identifique esta fila.",
  "ios.edit.deleteRow": "Eliminar fila",
  "ios.edit.review": "Revisar",
  "ios.edit.was": "antes: {value}",
  "ios.edit.reviewTitle": "Revisa el cambio",
  "ios.edit.production": "«{name}» es de producción: el cambio se aplica sobre datos reales.",
  "ios.edit.sql": "Se ejecutará",
  "ios.edit.oneRow": "Una fila, por su clave primaria, en una transacción. Si afecta a otro número de filas, se deshace.",
  "ios.edit.rolledBack": "No se aplicó nada: la transacción se deshizo. Tu cambio sigue aquí para corregirlo.",
  "ios.edit.confirm": "Confirmar con Face ID",
  "ios.edit.confirmDelete": "Eliminar con Face ID",
  "ios.edit.faceIdReason": "Confirmar el cambio en {table}",
  "ios.edit.affected": "El cambio afectaba a {n} filas en vez de a una; se deshizo.",
