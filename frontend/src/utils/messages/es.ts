...
export const es: Record<string, string> = {
  ...
  "ios.browse.tables": "Tablas",
  "ios.browse.views": "Vistas",
  "ios.browse.routines": "Rutinas",
  "ios.browse.empty": "Nada por aquí.",
  "ios.browse.failed": "No se pudo leer",
  "ios.rows.none": "Sin filas.",
  "ios.rows.filter": "Filtrar y ordenar",
  "ios.rows.addFilter": "Añadir filtro",
  "ios.rows.sort": "Ordenar por",
  "ios.rows.removeFilter": "Quita este filtro",
  "ios.rows.column": "Columna",
  "ios.rows.operator": "Operador",
  "ios.rows.value": "Valor",
  "ios.rows.apply": "Aplicar",
  "ios.row.pointsAt": "Apunta a",
  "ios.row.dependents": "Filas que dependen de esta",
  "ios.row.related": "Datos relacionados",
  "ios.row.missingKey": "{table}: la lista no trae la columna {column} de la llave",
  "ios.row.readOnlyEngine": "{engine} es de solo lectura en Squaero: no se puede editar.",
  "ios.row.readOnlyNoPk": "Solo lectura: la tabla no tiene clave primaria, y sin ella no se puede señalar una sola fila.",
  "ios.edit.action": "Editar",
  "ios.edit.discard": "Descartar",
  "ios.edit.review": "Revisar",
  "ios.edit.null": "NULL",
  "ios.edit.key": "clave",
  "ios.edit.previewTitle": "Revisar el cambio",
  "ios.edit.affectsOne": "Afecta a 1 fila, señalada por su clave primaria.",
  "ios.edit.affectsN": "Afecta a {n} filas, cada una señalada por su clave primaria.",
  "ios.edit.transaction": "Se ejecuta en una transacción: si algo falla, se deshace entero.",
  "ios.edit.production": "{name} es una conexión de producción.",
  "ios.edit.confirm": "Confirmar con Face ID",
  "ios.edit.faceid": "Aplicar el cambio en {name}",
  "ios.edit.cancelled": "Face ID cancelado: no se envió nada.",
  "ios.edit.failed": "No se aplicó y se deshizo la transacción: {reason}",
  "ios.edit.rollbackFailed": "Además, no se pudo deshacer la transacción: {reason}. Vuelve a conectar antes de seguir.",
  "ios.edit.done": "Cambio confirmado ({n} fila(s)).",
  "ios.edit.delete": "Eliminar fila",
  "ios.edit.deleted": "Fila eliminada.",
  "ios.edit.rowCount": "La sentencia {n} afectó a {count} filas en vez de a una: se deshizo la transacción.",
  "ios.edit.was": "antes: {value}",
  "ios.conn.production": "Producción",
  "ios.conn.productionHint": "Cada cambio en esta conexión lo advierte antes de pedir Face ID. Es el rojo de escritorio; un grupo llamado «Producción» también cuenta.",
  "ios.query.noConnection": "Sin conexión abierta",
  "ios.query.noConnectionHint": "Abre una en Conexiones y vuelve aquí para escribir SQL contra ella.",
  "ios.query.run": "Ejecutar",
  "ios.query.rows": "{n} filas · {time}",
  "ios.query.rowsMore": "{n}+ filas · {time}",
  "ios.query.affected": "{n} filas afectadas · {time}",
  "ios.query.statements": "Se ejecutaron {n} sentencias; se muestra la última.",
  "ios.query.failedAt": "Falló la sentencia {n} de {total}: {reason}",
  "ios.query.keys": "Teclas SQL",
  "ios.snip.save": "Guardar como snippet",
  "ios.snip.saveButton": "Guardar",
  "ios.snip.saved": "Guardado como «{name}».",
  "ios.snip.run": "Ejecutar",
  "ios.snip.openHint": "Tócalo para ejecutarlo en Consultas; mantenlo pulsado para abrirlo sin ejecutar, renombrarlo o borrarlo.",
  "ios.vars.hint": "Se recuerdan para la próxima vez.",
  "ios.vars.null": "NULL",
  "ios.export.action": "Exportar",
  "ios.export.title": "Exportar el resultado",
  "ios.export.format": "Formato",
  "ios.export.rows": "Filas",
  "ios.export.all": "Todas ({n}+, se leen del cursor)",
  "ios.export.allKnown": "Todas ({n})",
  "ios.export.visible": "Solo las visibles ({n})",
  "ios.export.name": "Nombre del archivo",
  "ios.export.save": "Guardar en Archivos",
  "ios.export.share": "Compartir",
  "ios.export.reading": "Leyendo filas… {n}",
  "ios.export.done": "{n} filas en {file}",
  "ios.export.desc.csv": "Texto separado por comas, para Excel, Numbers o cualquier hoja de cálculo. NULL queda vacío.",
  "ios.export.desc.json": "Un arreglo de objetos, uno por fila; NULL es null.",
  "ios.export.desc.xlsx": "Libro de Excel con una hoja; los números quedan como números.",
  "ios.export.desc.xml": "Un <row> por fila y un <field> por columna; NULL se marca null=\"true\".",
  "ios.export.desc.html": "Una página con la tabla, para leerla o pegarla en un documento.",
  "ios.export.desc.sql": "Un INSERT por fila, para cargarlas en otra base.",
  "ios.import.action": "Importar de escritorio",
  "ios.import.done": "Conexiones importadas",
  ...
  "ios.demo.section": "Probar sin servidor",
  ...
  "ios.agent.askFilter": "Pedir un filtro",
  "ios.agent.askPrompt": "Por ejemplo: solo las programadas de mañana",
  "ios.agent.thinking": "Pensando…",
  "ios.agent.noFilter": "No encontré un filtro con las columnas de esta tabla. Prueba a decirlo de otra forma.",
  "ios.agent.explainError": "Explicar el error",
  "ios.agent.explain": "Explicar la consulta",
  "ios.agent.ask": "Pedir datos",
  "ios.agent.askPrompt2": "Por ejemplo: ¿cuántas audiencias hay por sala esta semana?",
  "ios.agent.send": "Preguntar",
  "ios.agent.useInEditor": "Poner en el editor",
  "ios.agent.notRun": "No se ha ejecutado: revísala en el editor y ejecútala tú.",
  "ios.agent.noSchema": "No pude leer el esquema de la conexión.",
  "ios.agent.unavailable": "El asistente necesita iOS 26 con Apple Intelligence.",
  "ios.agent.change": "Pedir un cambio",
  "ios.agent.changePrompt": "Por ejemplo: márcala como celebrada",
  "ios.agent.changeFooter": "El asistente rellena la edición y abre la vista previa; nada se guarda sin tu confirmación con Face ID.",
  "ios.agent.noChange": "No encontré qué cambiar con las columnas de esta fila.",
  "ios.agent.eval": "Evaluar con la base de demostración",
  "ios.agent.evalRun": "Ejecutar la batería",
  "ios.agent.evalScore": "Aciertos",
  "ios.agent.evalCopy": "Copiar el resultado",
